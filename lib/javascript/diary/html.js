...
function totalsTable(){
  return `<h1 id="food-diary-header">Food Diary</h1>
          <div class="totals-table">
            <div class="left-div">Goal Calories: </div><div class="right-div"><span id="goal-calories"></span></div><br>
            <div class="left-div">Calories Consumed: </div><div class="right-div"><span id="calories-consumed"></span></div><br>
            <div class="left-div">Remaining Calories: </div><div class="right-div"><span id="remaining-calories"></div>
          </div>`
}
