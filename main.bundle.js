...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "22b38e6a2e04f2c82e8a95a4d4a726e6.jpg";

/***/ }),
/* 5 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "64ae6610de09f03fdd37239b29e437e2.png";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const FoodTable = __webpack_require__(10);
	const FoodForm = __webpack_require__(12);
	const FoodFilter = __webpack_require__(13);
...
/***/ (function(module, exports) {
	...
	function foodFilter() {
	  return `<form class="food-filter">
	            Filter by Name: <input type="text" name="food-filter" id="food-filter">
	          </form>`;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const TotalsTable = __webpack_require__(18);
	...
	class MealCard {
	  ...
	  deleteRow(event) {
	    ...
	    this.removeFood(foodid).then(function () {
	      row.remove();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const html = __webpack_require__(15);
	const MealCard = __webpack_require__(16);
	const FoodMenu = __webpack_require__(20);
	const Service = __webpack_require__(17);
	...
	class Diary {
	  ...
	  open() {
	    this.getFoodData().then(data => this.foods = data);

	    this.getMealData().then(data => this.meals = this.makeMeals(data)).then(this.serveMeals).then(this.updateTotals).then(() => this.listen());
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const Diary = __webpack_require__(19);

	$(document).ready(function () {
	   let diary = new Diary().open();
	});
