...
/***/ (function(module, exports, __webpack_require__) {
	...
	class MealCard {
	  ...
	  deleteRow(event) {
	    ...
	    this.removeFood(row.dataset.foodid).then(row.remove()).fail(function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	class Diary {
	  ...
	  open() {
	    this.meals = this.getMealData().then(data => this.meals = this.makeMeals(data)).then(this.serveMeals).then(() => {
	      this.listen();
	    });
	  }
