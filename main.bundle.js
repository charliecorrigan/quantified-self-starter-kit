...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "/lib/images/modfood2.jpg";

/***/ }),
/* 5 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "/lib/images/trash.jpg";
	...
	const getAllFoods = function () {
	  $.getJSON('https://quantify-this-api.herokuapp.com/api/v1/foods', function (result) {
	    $.each(result, function (i, field) {
	      $('table').append(`<tr><td>${field.name}</td><td>${field.calories}</td><td><button class="delete-icon">delete</button></td><tr>`);
	    });
	  });
	};
